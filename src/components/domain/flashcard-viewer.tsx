...
export function FlashcardViewer({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl">{t("practice.flashcardReview")}</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="rounded-2xl border border-border bg-slate-50 p-6">
          <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-500">{isFlipped ? t("practice.back") : t("practice.front")}</p>
